...
// export const SIGNIN_FORNECEDOR = '/signin-fornffecedor';
...
export const DELETE_FORNECEDOR = "/delete-maquina";
...
export const ADD_MACHINE = "/adicionar-maquina";
// export const EDIT_MACHINE = '/adicionar-maquina'

export const REMOTE_CREDIT = "/credito-remoto/:id";
export const EDIT_PROBABILIDADE_CLIENTE = "/edit-probabilidade-cliente";
...
export const EDIT_GARRA_MANUAL_GARRA_FORTE_CLIENTE = "/edit-garra-manual-garra-forte-cliente";
export const EDIT_GARRA_MANUAL_GARRA_MEDIA_CLIENTE = "/edit-garra-manual-garra-media-cliente";
export const EDIT_GARRA_MANUAL_GARRA_FRACA_CLIENTE = "/edit-garra-manual-garra-fraca-cliente";
export const EDIT_GARRA_MANUAL_GARRA_PREMIO_CLIENTE = "/edit-garra-manual-garra-premio-cliente";

export const VALOR_PULSO = "";
export const EDIT_GARRA_PREMIO_CLIENTE = "/edit-forca-premio-cliente";
export const HELP_PAGE = "/help-page-store_id";
export const TOKEN_HELP_PAGE = "/token-help-page";

export const DASHBOARD_CLIENTES = "/dashboard-clientes";
export const DELETE_CLIENTE = "/delete-cliente";
export const GRUA_ADM = "/menu-configurar-grua-adm";
export const ALTERAR_GRUA_CLIENTE = "/menu-configurar-grua-manual-cliente";
export const GRUA_CLIENTE = "/menu-configurar-grua-cliente";
export const CLIENTES_MAQUINAS = "/cliente-maquinas";
export const EDITAR_CLIENTES = "/editar-cliente";
export const ADD_CLIENTES = "/novo-cliente";
...
export const CLIENTES_MAQUINAS_EDIT_FORNECEDOR =
  "/cliente-maquinas/edit-pagamento-adm";
  export const GRUA_MANUAL_CLIENTE = "/manual-grua-cliente";
  export const GRUA_MANUAL_ADM = "/manual-grua-adm";
export const CLIENTES_MAQUINAS_DELETE_FORNECEDOR =
  "/cliente-maquinas/delete-pagamentos-adm";
export const CLIENTES_MAQUINA_DELETE_PAGAMENTOS =
  "/cliente-maquinas/delete-all-pagamentos-adm";
export const CLIENTES_MAQUINAS_TROCAR = "/cliente-maquinas/trocar";

export const ADD_CLIENTES_MAQUINA_ADM =
  "/cliente-maquinas/adicionar-maquina-adm";
export const CREDITO_REMOTO_ADM = "/cliente-maquinas/credito-remoto-adm";
export const EDIT_PROBABILIDADE_ADM = "/cliente-maquinas/edit-probabilidade-adm";
export const EDIT_GARRA_FORTE_ADM = "/cliente-maquinas/edit-forca-forte-adm";
...
export const EDIT_GARRA_MANUAL_GARRA_FORTE_ADM = "/cliente-maquinas/edit-garra-manual-garra-forte-adm";
